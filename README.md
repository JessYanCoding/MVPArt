# MVPArt
[ ![Bintray](https://img.shields.io/badge/bintray-v2.0.1-brightgreen.svg) ](https://bintray.com/jessyancoding/maven/MVPArt/2.0.1/link)
...
```
dependencies {
    compile 'me.jessyan:art:2.0.1'  //rxjava2
}
